package com.ibf.live.controller.praise;
...
import com.ibf.live.service.praise.PraiseService;
...
public class AppPraiseController extends BaseController {
	private static final Logger logger =  LoggerFactory.getLogger(AppPraiseController.class);
