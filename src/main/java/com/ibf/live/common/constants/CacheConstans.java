...
public class CacheConstans {
	...
	public static final int SUBJECT_COURSE_TIME = Integer.parseInt(webPropertyUtil.getProperty("SUBJECT_COURSE_TIME"));
	public static final String SUBJECT_COURSE = MEMFIX + "subject_course";
	...
	public static final String USER_LOGIN_COUNT = MEMFIX + "USER_LOGIN_COUNT";//当前前后端用户登录数
	public static final String USER_LOGIN_INFO = MEMFIX + "USER_LOGIN_INFO_";//当前前后端用户登录
}
