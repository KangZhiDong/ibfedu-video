package com.ibf.live.service.impl.statistics;
...
import com.ibf.live.dao.statistics.StatisticsDayDao;
import com.ibf.live.entity.statistics.StatisticsDay;
import com.ibf.live.service.statistics.StatisticsDayService;
...
public class StatisticsDayServiceImpl implements StatisticsDayService {
    ...
    public void addStatisticsDayAuto(){
    	...
    	RedisCacheUtil.del(CacheConstans.WEB_STATISTICS);
    	RedisCacheUtil.del(CacheConstans.WEB_STATISTICS_THIRTY+7);
    	RedisCacheUtil.del(CacheConstans.WEB_STATISTICS_THIRTY+15);
    	RedisCacheUtil.del(CacheConstans.WEB_STATISTICS_THIRTY+30);
    }
	...
	public StatisticsDay getStatisticsSumMsg(){
		...
		StatisticsDay statisticsDay= gson.fromJson(RedisCacheUtil.get(CacheConstans.WEB_STATISTICS),StatisticsDay.class);
        ...
        if (statisticsDay!=null) {
        	...
        	RedisCacheUtil.set(CacheConstans.WEB_STATISTICS, gson.toJson(statisticsDay));
        }
		return statisticsDay;
	}
	/**
	...
	public List<StatisticsDay> getStatisticThirty(int days){
		...
		List<StatisticsDay> statistics= gson.fromJson(RedisCacheUtil.get(CacheConstans.WEB_STATISTICS_THIRTY+days),new TypeToken<List<StatisticsDay>>(){}.getType());
        ...
        if (statistics!=null) {
        	...
        	RedisCacheUtil.set(CacheConstans.WEB_STATISTICS_THIRTY+days, gson.toJson(statistics), CacheConstans.WEB_STATISTICS_TIME);
        }
		return statistics;
	}
	/**
