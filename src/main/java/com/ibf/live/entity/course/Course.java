...
public class Course implements Serializable{
    ...
    private int courseType;//课程类别 0:单品课 1:套餐课(就业课)
    private String difficultyLevel;//课程难度DIFFICULTY_LEVEL
    private long learningCount;//正在学习的人数
    
    private String studyPercent;//课程学习进度百分比
    private String childrenIds;//子课程id集合
